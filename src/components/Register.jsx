...
const Register = () => {
  ...
  const googleLogin = async() => {
    ...
    Swal.fire({
      position: "top-end",
      icon: "success",
      title: "You have logged in by google",
      showConfirmButton: false,
      timer: 1500,
    });
  };
  ...
  const githubLogin = async() => {
    ...
    Swal.fire({
      position: "top-end",
      icon: "success",
      title: "You have logged in by github",
      showConfirmButton: false,
      timer: 1500,
    });
  };
  ...
  const facebookLogin = async() => {
    ...
    Swal.fire({
      position: "top-end",
      icon: "success",
      title: "You have logged in by facebook",
      showConfirmButton: false,
      timer: 1500,
    });
  };
      ...
      <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between ">
        ...
        <div className="lg:w-1/2 lg:max-w-md p-10 space-y-3 rounded-xl   lg:mr-16 border">
          ...
          <div className="flex justify-center items-center space-x-4">
            ...
            <FaFacebook onClick={facebookLogin} className="text-xl text-blue-600" />
          </div>
